...
def get_jobs_info(search_location):
    ...
    #this is code which will run after the cold start since the JOBS INFO will always exist
    #else block will only happen for the first time in which we are fetching location specific
    #data  
    if exists:
